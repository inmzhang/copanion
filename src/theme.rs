...
fn dark_theme() -> Theme {
    themed(
        BasePalette {
            ...
            border_focus: rgb(90, 200, 255),
            text: Color::White,
            muted: rgb(160, 160, 160),
            accent: rgb(90, 220, 240),
            cursor_line: rgb(70, 70, 70),
        },
        rgb(90, 170, 255),
        rgb(255, 210, 90),
        rgb(240, 90, 90),
...
fn light_theme() -> Theme {
    themed(
        BasePalette {
            bg: rgb(210, 210, 220),
            panel: rgb(245, 243, 232),
            border: rgb(100, 100, 100),
            border_focus: rgb(0, 60, 140),
            text: rgb(0, 0, 0),
            muted: rgb(80, 80, 80),
            accent: rgb(0, 100, 120),
            cursor_line: rgb(200, 200, 220),
        },
        rgb(0, 60, 140),
        rgb(140, 80, 0),
        rgb(160, 0, 0),
...
fn ayu_light_theme() -> Theme {
    themed(
        BasePalette {
            ...
            border: rgb(217, 216, 215),
            border_focus: rgb(54, 163, 217),
            text: rgb(92, 103, 115),
            muted: rgb(171, 176, 182),
            accent: rgb(54, 163, 217),
            cursor_line: rgb(240, 238, 228),
        },
        rgb(54, 163, 217),
        rgb(231, 197, 71),
        rgb(240, 113, 120),
...
fn catppuccin_theme(flavor: CatppuccinFlavor, syntect_theme: EmbeddedThemeName) -> Theme {
    themed(
        BasePalette {
            bg: flavor.mantle,
            panel: flavor.base,
            border: flavor.surface2,
            border_focus: flavor.blue,
            text: flavor.text,
            muted: flavor.overlay0,
            accent: flavor.teal,
            cursor_line: flavor.surface1,
        },
        flavor.blue,
        flavor.yellow,
        flavor.red,
...
fn gruvbox_theme(flavor: GruvboxFlavor) -> Theme {
    ...
    themed(
        BasePalette {
            ...
            panel: flavor.bg0,
            border: flavor.bg4,
            border_focus: flavor.aqua,
            text: flavor.fg0,
            muted: flavor.grey0,
            accent: flavor.aqua,
            cursor_line: flavor.selected_bg,
        },
        flavor.blue,
        flavor.yellow,
        flavor.red,
...
fn themed(
    ...
    Theme {
        ...
        muted: base.muted,
        accent: base.accent,
        note_bg: blend(base.panel, note_border, 20),
        note_border,
        question_bg: blend(base.panel, question_border, 20),
        question_border,
